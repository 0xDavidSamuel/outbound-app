...
export default function HomePage() {
  ...
  const CSS = `
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    html, body { height: 100%; background: #080808; color: #fff; font-family: 'DM Sans', sans-serif; overflow: hidden; }
    ...
    .headline { font-family: 'Bebas Neue', sans-serif; font-size: clamp(56px, 6.5vw, 100px); line-height: 0.9; color: #fff; margin-bottom: 16px; text-transform: none; }
    ...
    .scenario-num { font-family: 'Bebas Neue', sans-serif; font-size: 28px; color: rgba(232,85,58,0.6); line-height: 1; flex-shrink: 0; width: 28px; padding-top: 2px; }
    .scenario-body { flex: 1; }
    .scenario-city { font-family: 'DM Mono', monospace; font-size: 9px; letter-spacing: 0.25em; color: #e8553a; text-transform: uppercase; margin-bottom: 6px; }
    .scenario-text { font-size: 13px; color: #666; line-height: 1.75; font-weight: 300; }
    .features-grid { display: grid; grid-template-columns: repeat(2, 1fr); gap: 40px 48px; }
    ...
    @media (max-width: 768px) {
      ...
      .features-grid { grid-template-columns: repeat(2, 1fr); gap: 12px 16px; }
  ...
  return (
    <div>
      ...
      <div className="layout">
        <div className={`left ${revealed ? 'revealed' : ''}`}>
