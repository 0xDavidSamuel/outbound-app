    ...
    <>
      <style suppressHydrationWarning>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        :root { --bg: #080808; --accent: #e8553a; --text: #fff; --dim: #888; --border: #111; }
        ...
        .btn-enter { display: flex; align-items: center; gap: 10px; background: var(--accent); color: #fff; border: none; padding: 13px 28px; font-family: 'DM Mono', monospace; font-size: 11px; letter-spacing: 0.12em; text-transform: uppercase; border-radius: 6px; cursor: pointer; transition: opacity 0.2s, transform 0.15s; font-weight: 500; }
        ...
        .pillar-desc { font-size: 12px; color: #666; line-height: 1.6; font-weight: 300; }
        ...
        .stat-label { font-family: 'DM Mono', monospace; font-size: 9px; color: #555; letter-spacing: 0.2em; text-transform: uppercase; }
        ...
        .use-case-text { font-size: 13px; color: #666; line-height: 1.7; font-weight: 300; }
        .use-case-text strong { color: #aaa; font-weight: 500; }
        ...
        .final-sub { font-size: 13px; color: #555; font-style: italic; font-weight: 300; margin-bottom: 40px; }
      ...
      <div className="scroll-area" ref={scrollRef}>
        ...
        <section className="section">
          ...
          <div style={{ width: '100%', paddingTop: 20 }}>
            <h2 style={{ fontFamily: 'Bebas Neue, sans-serif', fontSize: 'clamp(52px, 7vw, 100px)', lineHeight: 0.9, color: '#fff', marginBottom: 48, textTransform: 'none' }}>Everything you<br />need on the road.</h2>
        ...
        <section className="section">
          ...
          <div style={{ maxWidth: 560 }}>
            ...
            <h2 style={{ fontFamily: 'Bebas Neue, sans-serif', fontSize: 'clamp(52px, 8vw, 106px)', lineHeight: 0.9, color: '#fff', marginBottom: 40, textTransform: 'none' }}>The world is your<br /><em style={{ color: '#e8553a', fontStyle: 'normal' }}>office.</em></h2>
        ...
        <section className="section">
          ...
          <div>
            <h2 style={{ fontFamily: 'Bebas Neue, sans-serif', fontSize: 'clamp(48px, 6vw, 88px)', lineHeight: 0.9, color: '#fff', marginBottom: 32, textTransform: 'none' }}>Built for moments<br /><em style={{ color: '#e8553a', fontStyle: 'normal' }}>like these.</em></h2>
        ...
        <section className="section">
          ...
          <div>
            <p style={{ fontFamily: 'DM Mono, monospace', fontSize: 9, letterSpacing: '0.4em', color: '#666', textTransform: 'uppercase', marginBottom: 16 }}>For the well-traveled and the soon-to-be.</p>
