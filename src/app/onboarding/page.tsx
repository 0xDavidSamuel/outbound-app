...
// First-time user ceremony — passport is "issued" after Web3Auth login
...
export default function OnboardingPage() {
  ...
  const [step, setStep]         = useState(-1);   // -1 = loading, 0..2 = steps, 3 = form
    ...
    <>
      <style suppressHydrationWarning>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .ob-passport::before {
          content: 'OUTBOUND · OUTBOUND · OUTBOUND · OUTBOUND · OUTBOUND · OUTBOUND';
          position: absolute;
          top: 50%; left: 50%;
