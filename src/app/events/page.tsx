    ...
    <>
      <style suppressHydrationWarning>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .event-banner-date { font-family: 'Bebas Neue', sans-serif; font-size: 48px; color: rgba(232,255,71,0.08); line-height: 1; letter-spacing: 0.05em; white-space: nowrap; overflow: hidden; }
        .event-body { padding: 16px; flex: 1; display: flex; flex-direction: column; gap: 8px; }
        .event-date { font-family: 'DM Mono', monospace; font-size: 9px; letter-spacing: 0.15em; color: #e8ff47; text-transform: uppercase; }
