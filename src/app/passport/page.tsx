...
export default function PassportPage() {
  ...
  if (loading) return (
    <div style={{ height:'100vh', background:'#080808', display:'flex', alignItems:'center', justifyContent:'center', flexDirection:'column', gap:16 }}>
      ...
      <p style={{ fontFamily:'DM Mono, monospace', fontSize:11, color:'#555', letterSpacing:'0.2em', textTransform:'uppercase' }}>loading passport...</p>
    ...
    <>
      <style suppressHydrationWarning>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .pp-label { font-family: 'DM Mono', monospace; font-size: 7.5px; letter-spacing: 0.35em; color: #555; text-transform: uppercase; margin-bottom: 3px; }
        ...
        .pp-value.muted { color: #444; font-style: italic; }
        ...
        .pp-btn-ghost:hover { border-color: #555; }
        .pp-chips { display: flex; flex-wrap: wrap; gap: 5px; margin-top: 16px; }
        .pp-chip { font-family: 'DM Mono', monospace; font-size: 8.5px; letter-spacing: 0.12em; text-transform: uppercase; padding: 4px 9px; border: 1px solid #1a1a1a; border-radius: 2px; color: #555; background: transparent; cursor: pointer; transition: all 0.14s; }
        .pp-chip:hover { border-color: #555; color: #888; }
        ...
        .pp-badge-seal { width: 36px; height: 36px; border-radius: 50%; border: 1.5px solid #1e1e1e; display: flex; align-items: center; justify-content: center; font-family: 'DM Mono', monospace; font-size: 6.5px; letter-spacing: 0.04em; color: #555; flex-shrink: 0; text-align: center; line-height: 1.2; padding: 3px; }
        ...
        .pp-badge-desc { font-family: 'DM Mono', monospace; font-size: 10px; color: #555; }
        ...
        .pp-section-head { font-family: 'DM Mono', monospace; font-size: 8px; letter-spacing: 0.4em; text-transform: uppercase; color: #555; margin-bottom: 11px; padding-bottom: 6px; border-bottom: 1px solid #141414; }
        ...
        .pp-vibe-btn:hover { border-color: #555; color: #888; }
        ...
        .pp-stats-tbl td:first-child { font-size: 8px; letter-spacing: 0.25em; text-transform: uppercase; color: #555; width: 55%; }
        ...
        .pp-loc-text.muted { color: #444; font-style: italic; }
        .pp-loc-edit-btn { font-family: 'DM Mono', monospace; font-size: 8px; letter-spacing: 0.15em; text-transform: uppercase; color: #555; background: transparent; border: 1px solid #1e1e1e; border-radius: 2px; padding: 4px 10px; cursor: pointer; transition: all 0.15s; }
        ...
        .pp-loc-input:focus { border-color: #444; }
        .pp-loc-input::placeholder { color: #444; }
        .pp-loc-detect { width: 100%; background: transparent; border: 1px dashed #1a1a1a; border-radius: 3px; padding: 8px; font-family: 'DM Mono', monospace; font-size: 8px; letter-spacing: 0.2em; text-transform: uppercase; color: #555; cursor: pointer; transition: all 0.2s; }
