  ...
  return (
    <>
      <style suppressHydrationWarning>{`
        ...
        .nav-wordmark { font-family: 'DM Mono', monospace; font-size: 9px; letter-spacing: 0.35em; color: #e8ff47; text-transform: uppercase; }
        ...
        .nav-upgrade { display: flex; align-items: center; gap: 5px; padding: 7px 12px; border-radius: 32px; cursor: pointer; font-family: 'DM Mono', monospace; font-size: 9px; letter-spacing: 0.12em; color: #e8ff47; text-transform: uppercase; background: rgba(232,255,71,0.06); border: none; transition: background 0.18s; white-space: nowrap; flex-shrink: 0; }
      ...
      <div className="nav-shell">
        <div className="nav-topbar">
          ...
          <div className="nav-avatar" onClick={() => router.push('/passport')} title={user.username}>
            {user.avatar_url ? <img src={user.avatar_url} alt="avatar" /> : (user.username?.[0] || '?').toUpperCase()}
          </div>
