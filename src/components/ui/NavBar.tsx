    ...
    <>
      <style suppressHydrationWarning>{`
        ...
        .nav-topbar {
          ...
          background: rgba(10,10,10,0.9); border: 1px solid #161616;
          border-radius: 40px; padding: 5px 14px 5px 16px;
        ...
        .nav-wordmark {
          ...
          letter-spacing: 0.35em; color: #e8ff47; text-transform: uppercase;
        }
        ...
        .nav-signout {
          ...
          color: #2a2a2a; text-transform: uppercase; background: none; border: none;
          cursor: pointer; transition: color 0.2s; padding: 0 2px;
        }
        .nav-signout:hover { color: #555; }

        .nav-pill-wrapper {
          width: 100%; max-width: 680px; padding: 0 16px; pointer-events: all;
        }

        .nav-pill {
          display: flex; align-items: center; gap: 2px;
          background: rgba(10,10,10,0.92); border: 1px solid #161616;
          border-radius: 40px; padding: 5px 6px;
          backdrop-filter: blur(20px); -webkit-backdrop-filter: blur(20px);
        ...
        .nav-item {
          ...
          padding: 7px 12px; border-radius: 32px; cursor: pointer;
          transition: background 0.18s, color 0.18s;
          font-family: 'DM Mono', monospace; font-size: 9px;
          letter-spacing: 0.12em; color: #383838;
        ...
        .nav-upgrade {
          ...
          padding: 7px 12px; border-radius: 32px; cursor: pointer;
          font-family: 'DM Mono', monospace; font-size: 9px;
          letter-spacing: 0.12em; color: #e8ff47; text-transform: uppercase;
          background: rgba(232,255,71,0.06); border: none;
